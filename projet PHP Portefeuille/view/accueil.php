    ...
    <header>
        <?php 
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                echo '<p><a href="logout.php" style="color: white;">Déconnexion</a></p>';
            } else {
        ...
        <img src="https://m.media-amazon.com/images/I/716dYY97ofL._AC_UF1000,1000_QL80_.jpg" alt="Wallets" style="width: 100%; max-width: 600px; height: auto; border-radius: 10px;">
    </header>
